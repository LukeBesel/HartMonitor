...
const MODULE_GUIDES: ModuleGuide[] = [
  ...
  },
  {
    ...
    link: '/analytics',
    linkLabel: 'Open App comparison',
    color: '#6366f1',
    steps: [
      'App comparison → pick a date range to see throughput, cycle time, and pass rates by app and operator.',
      'App comparison → OEE tab breaks down Availability, Performance, and Quality losses by station.',
