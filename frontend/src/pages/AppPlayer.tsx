      ...
      <div className="bg-gray-900 border-t border-white/10 px-6 py-3 flex items-center justify-between flex-shrink-0">
        ...
        {currentStepIdx < app.steps.length - 1 ? (
          ...
          <button onClick={complete} disabled={completing}
            className="flex items-center gap-2 px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
